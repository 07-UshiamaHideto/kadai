...
<div class="a_form">
	...
	<div class="a_left">趣味： </div><div class="a_right"><input type="checkbox" name="tas[]" value="スポーツ">スポーツ<input type="checkbox" name="tas[]" value="読書">読書<input type="checkbox" name="tas[]" value="ゲーム">ゲーム<input type="checkbox" name="tas[]" value="その他">その他</div>
</div>
	<div class="sub2">
